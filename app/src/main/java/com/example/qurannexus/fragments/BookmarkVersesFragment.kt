...
import com.example.qurannexus.models.BookmarkVerse
import com.example.qurannexus.models.adapters.BookmarkVersesAdapter
 ...
 * Use the [BookmarkVersesFragment.newInstance] factory method to
...
class BookmarkVersesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BookmarkVerseFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BookmarkVersesFragment().apply {
