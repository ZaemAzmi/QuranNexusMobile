...
import com.example.qurannexus.models.adapters.BookmarkChaptersAdapter
 ...
 * Use the [BookmarkChaptersFragment.newInstance] factory method to
...
class BookmarkChaptersFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BookmarkChapterFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BookmarkChaptersFragment().apply {
